    ...
    try {
        productForm.parse(req, async (err, fields, files) => {
            ...
            try {
                ...
                const { productId, producCategory, productBrand, productModel, productYear, productMileage, productEngineCapacity, productDescription, productPrice, oldCloudinaryPublicId, oldImagePath } = fields;
                ...
                const productData = {
                    ...
                    engineCapacity: productEngineCapacity,
...
export const getAllProducts = async (req, res) => {
    ...
    // incYe - по зростанню року;
    // decYe - по спаданню року;
    ...
    switch (true) {
        ...
        case req.query.sort === 'decPr' :
            sortObj.price = -1;
            break;
        case req.query.sort === 'incYe' :
            sortObj.year = 1;
            break;
        case req.query.sort === 'decYe' :
            sortObj.year = -1;
            break;
    ...
    if (req.query.search) {
        filterObj.$or = [
            ...
            { model: { $regex: new RegExp(req.query.search, "i") } }
          ]
    };
