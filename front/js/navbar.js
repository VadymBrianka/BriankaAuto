...
export const navbarRender = (user) => {
    ...
    navbarContainer.innerHTML = `
        <div class="site-name" id="navbarSiteName">
            <div class="shop-name site-name-item">Brianka Auto</div>
            <div class="fa fa-car site-name-item"></div>
        </div>
    ...
    switch (true) {
        ...
        case user === null:
            ...
            navbarMenu.innerHTML = `<nav class="navbar navbar-light navbar-expand-sm navbar-bg-body">
                                <div class="container">
                                    ...
                                    <div class="collapse navbar-collapse" id="n_bar">
                                        ...
                                        <div class="btn-container"></div>
                                            <li class="nav-item"><a class="nav-link" href="#" id="navbarProducts">CARS</a></li>
        ...
        navbarMenu.innerHTML = `<nav class="navbar navbar-light navbar-expand-lg navbar-bg-body">
                                    <div class="container">
