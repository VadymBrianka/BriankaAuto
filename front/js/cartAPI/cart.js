...
import { cartCardRender, clearCart } from "./cartCard.js";
...
export const cartRender =  () => {
    ...
    hidePagination();
        ...
        if (user.cart.length) {
            ...
            orderButton.innerHTML = `<button class="btn btn-success" id="orderCompleteBtn">Complete the order</button>`;
            ...
            clearCartButton.classList.add('cart-order-button-container');
            clearCartButton.innerHTML = `<button class="btn btn-danger" id="clearCartButton">Clear cart</button>`;
            cartContainer.appendChild(clearCartButton);
            attachEventHandler('clearCartButton', 'click', () => { clearCart() });
        } else {
