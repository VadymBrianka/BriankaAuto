...
const loginModalContent = `<form name="loginForm">
                                <table class="form-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-input"><div class="d-flex"><input type="password" name="userLoginPassword" id="userLoginPassword" class="form-control" required><span class="fas fa-eye password-btn" id="passwordBtn"> </span></div></td>
                                    </tr>
                                    <tr>
                                        <td></td>
...
attachEventHandler('passwordBtn', 'click', secretPassword);
...
function secretPassword() {
    ...
    const eyeIcon = document.getElementById('passwordBtn');
